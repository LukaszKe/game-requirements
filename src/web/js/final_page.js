var update_view = function (components, game) {
    ...
    if (game.hasOwnProperty('pc_requirements_minimum')) {
        ...
        document.getElementById('minimalSpace').innerHTML = game.pc_requirements_minimum.space;
    }
    ...
    if (game.hasOwnProperty('pc_requirements_recommended')) {
        ...
        document.getElementById('recommendedSpace').innerHTML = game.pc_requirements_recommended.space;
    }
}
