var update_view = function (components, game) {
    if (game.runs === true) {
        ...
        document.getElementById('doesGameWork').style = "color:#FFA500"
    }
    ...
    if (game.hasOwnProperty('pc_requirements_minimum')) {
        ...
        if (min_req.ram_ok === true) {
            ...
            document.getElementById('minimalMemory').style = "color:#FFA500"
        }
        if (min_req.free_space_ok === true) {
            ...
            document.getElementById('minimalSpace').style = "color:#FFA500"
        }
    ...
    if (game.hasOwnProperty('pc_requirements_recommended')) {
        ...
        if (rec_req.ram_ok === true) {
            ...
            document.getElementById('recommendedMemory').style = "color:#FFA500"
        }
        if (rec_req.free_space_ok === true) {
            ...
            document.getElementById('recommendedSpace').style = "color:#FFA500"
        }
